...
def open_admin_login():
    subprocess.Popen(["python", "admin_login.py"])  # Open the admin_login.py script
...
# Adding an additional button to open admin_login.py
additional_button = ctk.CTkButton(master=frame, text='Admin Login', command=open_admin_login)
additional_button.pack(pady=12, padx=10)
