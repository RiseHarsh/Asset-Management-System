...
# Submit buttons for Insert, Delete, and Update
...
delete_button = tk.Button(root, text="Delete", command=lambda: submit_data("Delete"), font=("times new roman", 15), bg="#03A9F4")
delete_button.place(relx=0.5, rely=0.7, anchor="center")

update_button = tk.Button(root, text="Update", command=lambda: submit_data("Update"), font=("times new roman", 15), bg="#03A9F4")
update_button.place(relx=0.7, rely=0.7, anchor="center")
